...
class ResNeSt(nn.Module):
    ...
    #                        layers=[3,3,5,8],
    #                        layer_strides=[2,1,2,2],
    #                        num_filters=[64,64,128,256],
    #                        groups=32, 
    #                        width_per_group=4) 
    # # width = int(out_planes * (width_per_group / 64.)) * groups
    ...
    def __init__(self, block,
        ...
        #         conv_layer(self.inplanes, stem_width, kernel_size=3, stride=2, padding=1, bias=False, **conv_kwargs),
        ...
        #     )
        # else:
        #     self.conv1 = conv_layer(self.inplanes, 64, kernel_size=7, stride=2, padding=3,
    ...
    def forward(self, x, return_interm: bool = True):
        # x = self.conv1(x)
        # x = self.bn1(x)
        # x = self.relu(x)
        # x = self.maxpool(x)

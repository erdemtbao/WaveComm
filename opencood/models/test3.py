...
# quantize_model = DiagonalGaussianDistribution
# z = torch.randn(4,32,64)
# posteriors = quantize_model(z)
# z_quantized = posteriors.sample() # 4,16,64
...
z = torch.randn(4,64,1,32)
token_decoder = TiTokDecoder2()
re_z = token_decoder(z)
print(re_z.shape)  # torch.Size([4, 64, 128, 256]) 64-channel,H:128,W:256